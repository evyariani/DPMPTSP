...
<div class="mb-6">
    <div class="flex justify-between items-center">
        <div>
            <h2 class="text-lg font-semibold text-gray-700">Tambah Program Baru</h2>
            <p class="text-gray-500">Isi formulir untuk menambahkan data program baru</p>
        </div>
        <a href="<?php echo e(route('program.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg flex items-center transition duration-200">
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-6">
        <form action="<?php echo e(route('program.store')); ?>" method="POST" id="formProgram">
            <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                placeholder="Masukkan nama program"><?php echo e(old('program')); ?></textarea>
                            <div class="mt-1 flex justify-between text-xs text-gray-500">
                                <span>Contoh: Program Pelayanan Penanaman Modal</span>
                                <span id="program-counter">0/200 karakter</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $rekenings ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>" <?php echo e(old('kode_rekening') == $key ? 'selected' : ''); ?>>
                                        <?php echo e($value); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 resize-textarea"
                                placeholder="Masukkan nama kegiatan"><?php echo e(old('kegiatan')); ?></textarea>
                            <div class="mt-1 flex justify-between text-xs text-gray-500">
                                <span>Contoh: Pelayanan Perizinan dan Non Perizinan Secara Terpadu Satu Pintu...</span>
                                <span id="kegiatan-counter">0/200 karakter</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 resize-textarea"
                                placeholder="Masukkan nama sub kegiatan"><?php echo e(old('sub_kegiatan')); ?></textarea>
                            <div class="mt-1 flex justify-between text-xs text-gray-500">
                                <span>Contoh: Penyediaan Pelayanan Perizinan Berusaha Melalui Sistem...</span>
                                <span id="subkegiatan-counter">0/200 karakter</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $pegawais ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($pegawai->id_pegawai); ?>" <?php echo e(old('id_pegawai') == $pegawai->id_pegawai ? 'selected' : ''); ?>>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 flex justify-end space-x-3">
                <a href="<?php echo e(route('program.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-6 py-2 rounded-lg flex items-center transition duration-200">
...
const pegawaiData = <?php echo json_encode($pegawaiData ?? [], 15, 512) ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Inisialisasi preview jika ada nilai old
    if (document.getElementById('id_pegawai').value) {
        updatePegawaiPreview();
    }
    
    if (document.getElementById('kode_rekening').value) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\PKL\dpmptsp\resources\views/admin/program-create.blade.php ENDPATH**/ ?>