    ...
    <div class="container">
        ...
        <table class="perjalanan-dinas">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="rincian-perjalanan">
                            <li><strong>Berangkat dari :</strong> <?php echo e($spd->tempat_berangkat ?? 'Pelaihari (tempat kedudukan)'); ?></li>
                            <li><strong>Ke :</strong> <?php echo e($spd->tempatTujuan->nama ?? 'Kota Banjarbaru'); ?></li>
                            <li><strong>Pada Tanggal :</strong> <?php echo e($spd->tanggal_berangkat ? $spd->tanggal_berangkat->format('d F Y') : '08 Juli 2024'); ?></li>
                            <li><strong>Kasubbag Umum dan Kepegawaian</strong> Selaku Pejabat Pelaksana Teknis Kegiatan</li>
                            <li style="margin-top: 15px;">
                                <strong><?php echo e($spd->pejabatTeknisPegawai->nama ?? 'LASMIATI, S. Tr'); ?></strong><br>
                                NIP. <?php echo e($spd->pejabatTeknisPegawai->nip ?? '19860412 201001 2 001'); ?>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="rincian-perjalanan">
                            <li><strong>Tiba :</strong> <?php echo e($spd->tempatTujuan->nama ?? 'Kota Banjarbaru'); ?></li>
                            <li><strong>Pada tanggal :</strong> <?php echo e($spd->tanggal_berangkat ? $spd->tanggal_berangkat->format('d F Y') : '08 Juli 2024'); ?></li>
                            <li><strong>Kepala :</strong> _________________</li>
                            <li style="margin-top: 10px;">
                                <strong>Berangkat dari :</strong> <?php echo e($spd->tempatTujuan->nama ?? 'Kota Banjarbaru'); ?>

                            </li>
                            <li><strong>Pada tanggal :</strong> <?php echo e($spd->tanggal_kembali ? $spd->tanggal_kembali->format('d F Y') : '09 Juli 2024'); ?></li>
                            <li><strong>Kepala :</strong> _________________</li>
                        </ul>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <ul class="rincian-perjalanan">
                            <li><strong>Tiba :</strong> <?php echo e($spd->tempat_berangkat ?? 'Pelaihari, Kab. Tanah Laut'); ?></li>
                            <li><strong>Pada tanggal :</strong> <?php echo e($spd->tanggal_kembali ? $spd->tanggal_kembali->format('d F Y') : '09 Juli 2024'); ?></li>
        ...
        <div class="ttd-wrapper">
            <div class="ttd-box">
                ...
                <br><br><br>
                <p class="nama"><?php echo e($spd->pejabatTeknisPegawai->nama ?? 'LASMIATI, S. Tr'); ?></p>
                <p class="nip">NIP. <?php echo e($spd->pejabatTeknisPegawai->nip ?? '19860412 201001 2 001'); ?></p>
            </div>
            <div class="ttd-box">
                <p class="jabatan">
                    <?php echo e($spd->penanda_tangan_jabatan ?? 'Kepala'); ?>,
                </p>
                <br><br><br>
