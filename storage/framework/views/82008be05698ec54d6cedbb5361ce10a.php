...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        ...
        <div class="flex gap-2">
            <!-- Tombol Cetak PDF -->
            <a href="<?php echo e(route('kwitansi.cetak', $kwitansi->id)); ?>" 
               target="_blank"
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800">
                        <?php echo e($kwitansi->tahun_anggaran); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 font-mono">
                        <?php echo e($kwitansi->kode_rekening); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800">
                        <?php echo e($kwitansi->sub_kegiatan); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 font-semibold">
                        Rp <?php echo e(number_format($kwitansi->nominal, 0, ',', '.')); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800">
                        <?php echo e(\Carbon\Carbon::parse($kwitansi->tanggal_kwitansi)->format('d/m/Y')); ?>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 min-h-[100px]">
                        <?php echo e($kwitansi->untuk_pembayaran); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800">
                        <?php echo e($kwitansi->pengguna_anggaran); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 font-mono">
                        <?php echo e($kwitansi->nip_pengguna_anggaran); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800">
                        <?php echo e($kwitansi->bendahara_pengeluaran); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 font-mono">
                        <?php echo e($kwitansi->nip_bendahara); ?>
                ...
                <div>
                    ...
                    <div class="w-full border border-gray-300 rounded-lg px-3 py-2 bg-gray-50 text-gray-800 font-mono">
                        <?php echo e($kwitansi->nip_penerima); ?>
