        ...
        <div class="p-6 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           name="nomor" 
                           value="<?php echo e(old('nomor', $rincian->nomor)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" 
                           name="tanggal" 
                           value="<?php echo e(old('tanggal', $rincian->tanggal instanceof \Carbon\Carbon ? $rincian->tanggal->format('Y-m-d') : $rincian->tanggal)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           name="tujuan" 
                           value="<?php echo e(old('tujuan', $rincian->tujuan)); ?>"
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="number" 
                                       id="jumlahPegawai"
                                       name="jumlah_pegawai"
                                       value="<?php echo e(old('jumlah_pegawai', count($rincian->pegawai))); ?>"
                                       min="1"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="<?php echo e(old('nominal_per_pegawai', $rincian->pegawai[0]['nominal'] ?? 300000)); ?>"
                                       min="0"
                                       step="50000"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                ...
                                <input type="number" 
                                       id="hari"
                                       name="hari"
                                       value="<?php echo e(old('hari', $rincian->pegawai[0]['hari'] ?? 1)); ?>"
                                       min="1"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNama"
                                       name="bendahara_nama"
                                       value="<?php echo e(old('bendahara_nama', $rincian->bendahara['nama'] ?? 'NURLITA FEBRIANA PRATIWI, A.Md')); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNip"
                                       name="bendahara_nip"
                                       value="<?php echo e(old('bendahara_nip', $rincian->bendahara['nip'] ?? '19980208 202012 2 007')); ?>"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('kepala_dinas_nama', $rincian->kepala_dinas['nama'] ?? 'BUDI ANDRIAN SUTANTO, S. Sos., M.M')); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('kepala_dinas_nip', $rincian->kepala_dinas['nip'] ?? '19760218 200701 1 006')); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" 
                           name="transport" 
                           id="transportInput"
                           value="<?php echo e(old('transport', $rincian->transport)); ?>"
...
<script>
    ...
    const existingPegawai = JSON.parse('<?php echo addslashes(json_encode($rincian->pegawai ?? [])); ?>');
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\DPMPTSP\DPMPTSP\resources\views/admin/rincian-edit.blade.php ENDPATH**/ ?>