...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        ...
        <a href="<?php echo e(route('rincian.create')); ?>" 
        ...
        <table class="w-full">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Bendahara</th>
                    <th class="px-4 py-3 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Kepala Dinas</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    ...
                    <td class="px-4 py-3 text-sm font-medium text-gray-800"><?php echo e($item->nomor); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-600"><?php echo e(\Carbon\Carbon::parse($item->tanggal)->format('d/m/Y')); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-600"><?php echo e($item->tujuan); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-600">
                        <div class="flex -space-x-2">
                            <?php $__currentLoopData = array_slice($item->pegawai, 0, 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="w-7 h-7 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center text-xs font-medium text-blue-600" title="<?php echo e($peg['nama']); ?>">
                                    <?php echo e(substr($peg['nama'], 0, 1)); ?>

                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php if(count($item->pegawai) > 2): ?>
                                <div class="w-7 h-7 rounded-full bg-gray-100 border-2 border-white flex items-center justify-center text-xs font-medium text-gray-600" title="<?php echo e(count($item->pegawai) - 2); ?> pegawai lainnya">
                                    +<?php echo e(count($item->pegawai) - 2); ?>

                                </div>
                            <?php endif; ?>
                        </div>
                    </td>
                    <td class="px-4 py-3 text-sm text-right text-gray-600">Rp <?php echo e(number_format($item->transport)); ?></td>
                    <td class="px-4 py-3 text-sm text-gray-600">
                        <?php
                            $bendahara = $item->pegawai[0] ?? null;
                        ?>
                        <?php if($bendahara): ?>
                            <div class="text-sm font-medium text-gray-800"><?php echo e($bendahara['nama']); ?></div>
                            <div class="text-xs text-gray-500"><?php echo e($bendahara['nip'] ?? '-'); ?></div>
                        <?php else: ?>
                            <span class="text-gray-400">-</span>
                        <?php endif; ?>
                    </td>
                    <td class="px-4 py-3 text-sm text-gray-600">
                        <div class="text-sm font-medium text-gray-800">BUDI ANDRIAN SUTANTO, S. Sos., M.M</div>
                        <div class="text-xs text-gray-500">NIP. 19760218 200701 1 006</div>
                    </td>
                    <td class="px-4 py-3 text-sm text-right font-semibold text-gray-800">Rp <?php echo e(number_format($item->total)); ?></td>
                ...
                <tr>
                    <td colspan="10" class="px-4 py-12 text-center text-gray-400">
                        ...
                        <a href="<?php echo e(route('rincian.create')); ?>" class="text-blue-500 text-sm mt-2 inline-block">Tambah data pertama</a>
                    </td>
                </tr>
                <?php endif; ?>
            </tbody>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\DPMPTSP\DPMPTSP\resources\views/admin/rincian-bidang.blade.php ENDPATH**/ ?>