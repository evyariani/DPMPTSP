...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-6">
        <form action="/pegawai/<?php echo e($pegawai->id_pegawai); ?>" method="POST" id="formPegawai">
            <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Anda sedang mengedit data pegawai dengan ID: <span class="font-semibold"><?php echo e($pegawai->id_pegawai); ?></span>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="nama" 
                               name="nama" 
                               value="<?php echo e(old('nama', $pegawai->nama)); ?>"
                               required
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="nip" 
                               name="nip" 
                               value="<?php echo e(old('nip', $pegawai->nip)); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="pangkat" 
                               name="pangkat" 
                               value="<?php echo e(old('pangkat', $pegawai->pangkat)); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="gol" 
                               name="gol" 
                               value="<?php echo e(old('gol', $pegawai->gol)); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="jabatan" 
                               name="jabatan" 
                               value="<?php echo e(old('jabatan', $pegawai->jabatan)); ?>"
                               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="text" 
                                   id="tk_jalan" 
                                   name="tk_jalan" 
                                   value="<?php echo e(old('tk_jalan', $pegawai->tk_jalan)); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="text-sm text-gray-700 bg-gray-50 p-2 rounded border border-gray-200">
                                    <?php echo e($pegawai->created_at ? $pegawai->created_at->format('d/m/Y H:i') : '-'); ?>
                            ...
                            <div>
                                ...
                                <div class="text-sm text-gray-700 bg-gray-50 p-2 rounded border border-gray-200">
                                    <?php echo e($pegawai->updated_at ? $pegawai->updated_at->format('d/m/Y H:i') : '-'); ?>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200 flex justify-between items-center">
                <div class="text-sm text-gray-500">
                    <i class="fas fa-id-card mr-1"></i> ID Pegawai: <span class="font-medium"><?php echo e($pegawai->id_pegawai); ?></span>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\PKL\dpmptsp\resources\views/admin/edit-pegawai.blade.php ENDPATH**/ ?>