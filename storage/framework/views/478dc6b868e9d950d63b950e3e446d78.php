                ...
                <ul class="space-y-1 px-3">
                    ...
                    <?php elseif($userLevel == 'pegawai'): ?>
                        ...
                        <li>
                            <a href="/transaksi" 
                               class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group
                                      <?php echo e(request()->is('transaksi*') ? 'sidebar-link-active' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-700 hover:shadow-sm'); ?>"
                               :class="{'justify-center': !sidebarOpen}">
                        ...
                        <li>
                            <a href="/laporan" 
                               class="flex items-center gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 group
                                      <?php echo e(request()->is('laporan*') ? 'sidebar-link-active' : 'text-gray-700 hover:bg-blue-100 hover:text-blue-700 hover:shadow-sm'); ?>"
                               :class="{'justify-center': !sidebarOpen}">
...
</html><?php /**PATH C:\POLITALA\DPMPTSP\DPMPTSP\resources\views/layouts/admin.blade.php ENDPATH**/ ?>