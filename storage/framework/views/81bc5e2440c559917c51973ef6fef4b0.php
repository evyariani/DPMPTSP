<?php $__env->startSection('title', 'Tambah Uang Harian'); ?>
        ...
        <form action="/uang-harian" method="POST" id="formUangHarian">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="provinsi_id" 
                            ...
                            <?php $__currentLoopData = $provinsis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $provinsi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($provinsi->id); ?>" <?php echo e(old('provinsi_id') == $provinsi->id ? 'selected' : ''); ?>>
                    ...
                    <div id="kabupaten-container" class="<?php echo e($isKalsel ? '' : 'hidden'); ?>">
                        <label for="kabupaten_id" class="block text-sm font-medium text-gray-700 mb-2">
                            Kabupaten/Kota Tujuan <?php if($isKalsel): ?><span class="text-red-500">*</span><?php endif; ?>
                        </label>
                    ...
                    <div id="kecamatan-container" class="<?php echo e($isTanahLaut ? '' : 'hidden'); ?>">
                        <label for="kecamatan_id" class="block text-sm font-medium text-gray-700 mb-2">
                            Kecamatan Tujuan <?php if($isTanahLaut): ?><span class="text-red-500">*</span><?php endif; ?>
                        </label>
                    ...
                    <div>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg border border-gray-200">
                            <p id="daerah_tujuan_text" class="text-gray-700 min-h-[42px]">
                                <?php if(old('provinsi_id')): ?>
                                    <?php echo e($selectedKecamatan->nama ?? $selectedKabupaten->nama ?? $selectedProvinsi->nama ?? ''); ?>
                        ...
                        <input type="hidden" id="daerah_id" name="daerah_id" value="<?php echo e(old('daerah_id')); ?>">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   id="uang_harian" 
                                   name="uang_harian" 
                                   value="<?php echo e(old('uang_harian') ? number_format(old('uang_harian'), 0, ',', '.') : ''); ?>"
                                   required
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" 
                                   id="uang_transport" 
                                   name="uang_transport" 
                                   value="<?php echo e(old('uang_transport') ? number_format(old('uang_transport'), 0, ',', '.') : ''); ?>"
                                   required
                                   class="w-full pl-12 px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                                   placeholder="0">
                        </div>
            ...
            .then(data => {
                ...
                if (data.success && data.can_select_kabupaten && data.data && data.data.length > 0) {
                    ...
                    data.data.forEach(function(kabupaten) {
                        ...
                        <?php if(old('kabupaten_id')): ?>
                            if (kabupaten.id == '<?php echo e(old('kabupaten_id')); ?>') {
            ...
            .then(data => {
                ...
                if (data.success && data.can_select_kecamatan && data.data && data.data.length > 0) {
                    ...
                    data.data.forEach(function(kecamatan) {
                        ...
                        <?php if(old('kecamatan_id')): ?>
                            if (kecamatan.id == '<?php echo e(old('kecamatan_id')); ?>') {
                                option.selected = true;
                            }
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\PKL\dpmptsp\resources\views/admin/uang-harian-create.blade.php ENDPATH**/ ?>