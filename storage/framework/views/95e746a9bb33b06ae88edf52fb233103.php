...
<div class="bg-white rounded-lg shadow p-4 mb-6">
    <form method="GET" action="<?php echo e(route('rincian.index')); ?>" class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
        <div class="flex-1">
        ...
        <div class="flex flex-wrap gap-2">
            ...
            <?php if(request()->has('search')): ?>
                <a href="<?php echo e(route('rincian.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg transition duration-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <?php echo e($rincian->firstItem() + $key); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="sppd-badge">
                            <i class="fas fa-file-alt mr-1 text-xs"></i> <?php echo e($item->nomor_sppd ?? '-'); ?>
                    ...
                    <td class="px-6 py-4 text-wrap-cell fixed-col-tujuan table-cell-hover">
                        <div class="text-sm text-gray-900" title="<?php echo e($item->tempat_tujuan ?? '-'); ?>">
                            <i class="fas fa-map-marker-alt text-gray-400 mr-1 text-xs"></i>
                            <?php echo e(Str::limit($item->tempat_tujuan ?? '-', 50)); ?>

                        </div>
                        <?php if($item->spd && $item->spd->tempatTujuan && strlen($item->spd->tempatTujuan->nama) > 50): ?>
                            <button type="button" 
                                    onclick="showFullText(this, '<?php echo e(addslashes($item->spd->tempatTujuan->nama)); ?>', 'Tujuan Perjalanan')"
                    ...
                    <td class="px-6 py-4">
                        ...
                        <div class="text-xs text-gray-500 mt-1">
                            <i class="fas fa-users mr-1"></i> <?php echo e(count($pegawaiList)); ?> orang
                        </div>
                    </td>
                    ...
                    <td colspan="10" class="px-6 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <div class="mt-3 flex gap-2">
                                <a href="<?php echo e(route('rincian.sync-all')); ?>" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg inline-flex items-center text-sm">
