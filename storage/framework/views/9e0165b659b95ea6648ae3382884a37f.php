<?php $__env->startSection('title', 'Tambah Surat Perintah Tugas (SPT)'); ?>
...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-6">
        <form action="<?php echo e(route('spt.store')); ?>" method="POST" id="formSPT">
            <?php echo csrf_field(); ?>
                            ...
                            <div class="flex items-center space-x-2">
                                <div class="flex-1">
                                    <input type="number" 
                                           name="nomor_urut" 
                                           id="nomor_urut"
                                           value="<?php echo e(old('nomor_urut')); ?>"
                                           min="1" 
                                           max="999"
                                           required
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="font-mono text-md font-semibold text-blue-700 break-all" id="preview-nomor-surat">
                                            800.1.11.1/<span id="preview-nomor-urut" class="text-gray-400">___</span>/DPMPTSP/<span id="preview-tahun"><?php echo e(date('Y')); ?></span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <select id="penanda_tangan" 
                            ...
                            <?php $__currentLoopData = $penandaTangans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pegawai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($pegawai->id_pegawai); ?>" <?php echo e(old('penanda_tangan') == $pegawai->id_pegawai ? 'selected' : ''); ?>>
            ...
            <div class="mb-6">
                ...
                <div id="dasar-container" class="space-y-3">
                    <?php
                        $oldDasar = old('dasar', ['']);
                    ?>
                    <?php $__currentLoopData = $oldDasar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mb-6">
                ...
                <div id="pegawai-container" class="space-y-3">
                    ...
                    ?>
                    <?php $__currentLoopData = $oldPegawai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="mb-6">
                ...
                <textarea id="tujuan" 
                          ...
                          required
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200"
                          placeholder="Jelaskan tujuan penugasan..."><?php echo e(old('tujuan')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PKL POLITALA\dpmptsp\resources\views/admin/spt-create.blade.php ENDPATH**/ ?>