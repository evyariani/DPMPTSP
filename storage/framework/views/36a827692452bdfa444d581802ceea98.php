...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <form action="<?php echo e(route('kwitansi.update', $kwitansi->id)); ?>" method="POST" class="p-6">
        ...
        <input type="hidden" name="spd_id" value="<?php echo e($kwitansi->spd_id); ?>">
                    ...
                    <div class="p-4 space-y-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($kwitansi->spd->nomor_surat ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">Maksud Perjalanan</label>
                                <input type="text" value="<?php echo e($kwitansi->spd->maksud_perjadin ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4 space-y-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($kwitansi->tahun_anggaran ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">Kode Rekening</label>
                                <input type="text" value="<?php echo e($kwitansi->kode_rekening ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-mono" readonly>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs text-gray-500 mb-1">Sub Kegiatan</label>
                                <textarea rows="2" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly><?php echo e($kwitansi->sub_kegiatan ?? '-'); ?></textarea>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs text-gray-500 mb-1">Untuk Pembayaran</label>
                                <textarea name="untuk_pembayaran" id="untuk_pembayaran" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"><?php echo e(old('untuk_pembayaran', $kwitansi->untuk_pembayaran)); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="border border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 space-y-3">
                            <div>
                                ...
                                <input type="text" value="<?php echo e($kwitansi->pengguna_anggaran ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">NIP</label>
                                <input type="text" value="<?php echo e($kwitansi->nip_pengguna_anggaran ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-mono" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="border border-gray-300 rounded-lg overflow-hidden">
                        ...
                        <div class="p-4 space-y-3">
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">Nama</label>
                                <input type="text" value="<?php echo e($kwitansi->bendahara_pengeluaran ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm" readonly>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">NIP</label>
                                <input type="text" value="<?php echo e($kwitansi->nip_bendahara ?? '-'); ?>" class="w-full px-3 py-2 bg-gray-100 border border-gray-300 rounded-lg text-sm font-mono" readonly>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="p-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="penerima" id="penerima" value="<?php echo e(old('penerima', $kwitansi->penerima)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">NIP Penerima <span class="text-red-500">*</span></label>
                                <input type="text" name="nip_penerima" id="nip_penerima" value="<?php echo e(old('nip_penerima', $kwitansi->nip_penerima)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="nominal" id="nominal" value="<?php echo e(old('nominal', $kwitansi->nominal)); ?>" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                                </div>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">No. BKU <span class="text-red-500">*</span></label>
                                <input type="text" name="no_bku" id="no_bku" value="<?php echo e(old('no_bku', $kwitansi->no_bku)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">No. BRPP</label>
                                <input type="text" name="no_brpp" id="no_brpp" value="<?php echo e(old('no_brpp', $kwitansi->no_brpp)); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-500 mb-1">Tanggal Kwitansi <span class="text-red-500">*</span></label>
                                <input type="date" name="tanggal_kwitansi" id="tanggal_kwitansi" value="<?php echo e(old('tanggal_kwitansi', $kwitansi->tanggal_kwitansi ? \Carbon\Carbon::parse($kwitansi->tanggal_kwitansi)->format('Y-m-d') : date('Y-m-d'))); ?>" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                            </div>
                            <div class="md:col-span-2">
                                <label class="block text-xs text-gray-500 mb-1">Terbilang <span class="text-red-500">*</span></label>
                                <textarea name="terbilang" id="terbilang" rows="2" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" required><?php echo e(old('terbilang', $kwitansi->terbilang)); ?></textarea>
