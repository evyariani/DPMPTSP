<?php $__env->startSection('title', 'Uang Harian'); ?>
    ...
    <form method="GET" action="/uang-harian" class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div class="flex flex-wrap gap-2">
            <select name="tingkat" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <option value="kabupaten" <?php echo e(request('tingkat') == 'kabupaten' ? 'selected' : ''); ?>>Kabupaten/Kota</option>
            ...
            <?php if(request()->hasAny(['search', 'tingkat'])): ?>
    ...
    <div class="mt-4 pt-3 border-t border-gray-200">
        <div class="flex items-center flex-wrap gap-2">
            ...
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800">
                <i class="fas fa-tag mr-1"></i> <?php echo e(ucfirst(request('tingkat'))); ?>

                <a href="<?php echo e(request()->fullUrlWithQuery(['tingkat' => null])); ?>" class="ml-2 text-purple-600 hover:text-purple-800">
                    <i class="fas fa-times"></i>
                </a>
            </span>
            <?php endif; ?>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $uangHarians; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $uang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <?php
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                        <?php echo e(($uangHarians->currentPage() - 1) * $uangHarians->perPage() + $index + 1); ?>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-8 w-8">
                                <div class="h-8 w-8 rounded-full bg-indigo-100 flex items-center justify-center">
                                    <i class="fas <?php echo e($icon); ?> text-indigo-600 text-sm"></i>
                                </div>
                            </div>
                            <div class="ml-3">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($uang->tempat_tujuan ?? '-'); ?></div>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-green-600 font-medium">
                            Rp <?php echo e(number_format($uang->uang_harian, 0, ',', '.')); ?>

                        </span>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <span class="text-blue-600 font-medium">
                            Rp <?php echo e(number_format($uang->uang_transport, 0, ',', '.')); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            <a href="/uang-harian/<?php echo e($uang->id_uang_harian); ?>/edit" 
                            ...
                            <button type="button" 
                                    onclick="showDeleteConfirmation(
                                        <?php echo e($uang->id_uang_harian); ?>, 
                                        '<?php echo e(addslashes($uang->tempat_tujuan)); ?>', 
                                        'Rp <?php echo e(number_format($uang->uang_harian ?? 0, 0, ',', '.')); ?>',
                                        'Rp <?php echo e(number_format($uang->uang_transport ?? 0, 0, ',', '.')); ?>',
                                        'Rp <?php echo e(number_format($total, 0, ',', '.')); ?>'
                                    )"
...
<!-- PAGINATION -->
<?php if($uangHarians->hasPages()): ?>
<div class="mt-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
    <div class="text-sm text-gray-700">
        Menampilkan 
        <span class="font-medium"><?php echo e($uangHarians->firstItem() ?: 0); ?></span> 
        sampai 
        <span class="font-medium"><?php echo e($uangHarians->lastItem() ?: 0); ?></span> 
        dari 
        <span class="font-medium"><?php echo e($uangHarians->total()); ?></span> 
        uang harian
    </div>
    
    <div class="flex items-center space-x-1">
        <?php if($uangHarians->onFirstPage()): ?>
            <span class="px-3 py-1.5 border rounded text-gray-400 cursor-not-allowed">
                <i class="fas fa-chevron-left text-xs"></i>
            </span>
        <?php else: ?>
            <a href="<?php echo e($uangHarians->previousPageUrl()); ?>" class="px-3 py-1.5 border rounded hover:bg-gray-100 transition duration-150">
                <i class="fas fa-chevron-left text-xs"></i>
            </a>
        <?php endif; ?>
        
        <?php $__currentLoopData = $uangHarians->getUrlRange(max($uangHarians->currentPage() - 2, 1), min($uangHarians->currentPage() + 2, $uangHarians->lastPage())); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($page == $uangHarians->currentPage()): ?>
                <span class="px-3 py-1.5 border rounded bg-blue-600 text-white"><?php echo e($page); ?></span>
            <?php else: ?>
                <a href="<?php echo e($url); ?>" class="px-3 py-1.5 border rounded hover:bg-gray-100 transition duration-150"><?php echo e($page); ?></a>
            <?php endif; ?>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        
        <?php if($uangHarians->hasMorePages()): ?>
            <a href="<?php echo e($uangHarians->nextPageUrl()); ?>" class="px-3 py-1.5 border rounded hover:bg-gray-100 transition duration-150">
...
<div class="mt-4 text-xs text-gray-400 text-center">
    <i class="fas fa-database mr-1"></i> Total <?php echo e($totalData ?? 0); ?> data • 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PKL POLITALA\dpmptsp\DPMPTSP\resources\views/admin/uang-harian.blade.php ENDPATH**/ ?>