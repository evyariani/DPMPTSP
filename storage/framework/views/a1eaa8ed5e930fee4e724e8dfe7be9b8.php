...
<?php $__env->startSection('title', 'Tambah Rincian Biaya Perjalanan Dinas'); ?>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <div class="flex justify-between items-center p-6 border-b border-gray-200">
        <div>
            <h2 class="text-xl font-semibold text-gray-800">Tambah Rincian Biaya</h2>
            <p class="text-sm text-gray-500 mt-1">Isi form untuk menambah rincian biaya perjalanan dinas</p>
        </div>
    ...
    <form method="POST" action="<?php echo e(route('rincian.store')); ?>" id="formRincian">
        <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['nomor'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="date" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['tanggal'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent <?php $__errorArgs = ['tujuan'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="number" 
                                       id="jumlahPegawai"
                                       name="jumlah_pegawai"
                                       value="<?php echo e(old('jumlah_pegawai', 1)); ?>"
                                       min="1"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="<?php echo e(old('nominal_per_pegawai', 300000)); ?>"
                                       min="0"
                                       step="50000"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNama"
                                       name="bendahara_nama"
                                       value="<?php echo e(old('bendahara_nama', 'NURLITA FEBRIANA PRATIWI, A.Md')); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNip"
                                       name="bendahara_nip"
                                       value="<?php echo e(old('bendahara_nip', '19980208 202012 2 007')); ?>"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('kepala_dinas_nama', 'BUDI ANDRIAN SUTANTO, S. Sos., M.M')); ?>"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="<?php echo e(old('kepala_dinas_nip', '19760218 200701 1 006')); ?>"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" 
                           name="transport" 
                           id="transportInput"
                           value="<?php echo e(old('transport', 0)); ?>"
...
<script>
    ...
    function updateNamaPegawaiForms(jumlah) {
        ...
        const oldNamaInputs = document.querySelectorAll('input[name="nama_pegawai[]"]');
        const oldNipInputs = document.querySelectorAll('input[name="nip_pegawai[]"]');
        
        for (let i = 0; i < oldNamaInputs.length; i++) {
            existingNama[i] = oldNamaInputs[i]?.value || '';
            existingNip[i] = oldNipInputs[i]?.value || '';
        }
        ...
        for (let i = 0; i < jumlah; i++) {
            ...
            div.innerHTML = `
                <div class="flex items-center gap-2">
                    ...
                    <input type="text" 
                           name="nama_pegawai[]" 
                           value="${escapeHtml(existingNama[i] || '')}"
                           placeholder="Nama Pegawai ${i+1}"
                           class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                    <input type="text" 
                           name="nip_pegawai[]" 
                           value="${escapeHtml(existingNip[i] || '')}"
                           placeholder="NIP"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\DPMPTSP\DPMPTSP\resources\views/admin/rincian-create.blade.php ENDPATH**/ ?>