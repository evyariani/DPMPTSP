    ...
    <div class="info-card">
        ...
        <div class="p-6">
            ...
            <div id="hasil-container" class="space-y-3">
                ...
                ?>
                <?php $__currentLoopData = $hasilList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $hasil): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-start space-x-2 hasil-item">
                    <div class="flex-grow">
                        <textarea 
                            ...
                            placeholder="Contoh: Rapat koordinasi membahas anggaran tahun 2025..."><?php echo e($hasil); ?></textarea>
                    </div>
                    <button type="button" 
                            class="remove-hasil bg-red-100 text-red-600 hover:bg-red-200 px-3 py-2 rounded-lg transition duration-200"
                            title="Hapus hasil"
                            <?php echo e($loop->first && $hasilList->count() == 1 ? 'disabled style="opacity:0.5;cursor:not-allowed;display:none;"' : ''); ?>>
                        <i class="fas fa-times"></i>
                    </button>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
