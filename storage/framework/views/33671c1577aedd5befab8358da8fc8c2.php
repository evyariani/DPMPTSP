    ...
    <form method="GET" action="/pegawai" class="flex flex-col md:flex-row md:items-center space-y-4 md:space-y-0 md:space-x-4">
        ...
        <div class="flex flex-wrap gap-2">
            <select name="pangkat" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <?php $__currentLoopData = $pangkatList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pangkat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($pangkat); ?>" <?php echo e(request('pangkat') == $pangkat ? 'selected' : ''); ?>>
                        <?php echo e($pangkat); ?>
            ...
            <select name="golongan" class="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                ...
                <?php $__currentLoopData = $golonganList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $golongan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($golongan); ?>" <?php echo e(request('golongan') == $golongan ? 'selected' : ''); ?>>
                        <?php echo e($golongan); ?>
            ...
            <?php if(request()->has('search') || request()->has('pangkat') || request()->has('gol')): ?>
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    <td class="px-6 py-4 whitespace-nowrap">
                        <?php if($isPaginated): ?>
                            <?php echo e(($pegawais->currentPage() - 1) * $pegawais->perPage() + $index + 1); ?>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10">
                                <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                                    <span class="text-indigo-600 font-semibold"><?php echo e(strtoupper(substr($pegawai->nama ?? '', 0, 1))); ?></span>
                                </div>
                            </div>
                            <div class="ml-4">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <?php if(!empty($pegawai->tk_jalan)): ?>
                            <?php
                                // Cek apakah tk_jalan berupa angka (bisa diformat sebagai uang)
                                $isNumeric = is_numeric($pegawai->tk_jalan);
                            ?>
                            
                            <?php if($isNumeric && $pegawai->tk_jalan > 0): ?>
                                
                                <span class="text-green-600 font-medium">
                                    Rp <?php echo e(number_format($pegawai->tk_jalan, 0, ',', '.')); ?>

                                </span>
                            <?php elseif($isNumeric && $pegawai->tk_jalan == 0): ?>
                            ...
                            <?php else: ?>
                                ...
                                <span class="px-2 py-1 rounded text-xs font-medium bg-yellow-100 text-yellow-800 border border-yellow-200">
                                    <?php echo e(strtoupper($pegawai->tk_jalan)); ?>
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            ...
                            <a href="/pegawai/<?php echo e($pegawai->id_pegawai); ?>/edit" 
                            ...
                            <button type="button" 
                                    onclick="showDeleteConfirmation(<?php echo e($pegawai->id_pegawai); ?>, '<?php echo e(addslashes($pegawai->nama)); ?>', '<?php echo e($pegawai->nip ?? ''); ?>')"
...
<div class="mt-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
    <div class="text-sm text-gray-700">
        Menampilkan 
        <span class="font-medium"><?php echo e($pegawais->firstItem() ?: 0); ?></span> 
        sampai 
        <span class="font-medium"><?php echo e($pegawais->lastItem() ?: 0); ?></span> 
        dari 
        <span class="font-medium"><?php echo e($pegawais->total()); ?></span> 
        pegawai
    </div>
    
    <div class="flex items-center space-x-1">
        
        <?php if($pegawais->onFirstPage()): ?>
            <span class="px-3 py-1.5 border rounded text-gray-400 cursor-not-allowed">
                <i class="fas fa-chevron-left text-xs"></i>
            </span>
        <?php else: ?>
            <a href="<?php echo e($pegawais->previousPageUrl()); ?>" 
        ...
        <?php if($start > 1): ?>
            <a href="<?php echo e($pegawais->url(1)); ?>" 
        ...
        <?php for($page = $start; $page <= $end; $page++): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e($pegawais->url($page)); ?>" 
        ...
        <?php if($end < $last): ?>
            <?php if($end < $last - 1): ?>
                <span class="px-3 py-1.5 text-gray-500">...</span>
            <?php endif; ?>
            <a href="<?php echo e($pegawais->url($last)); ?>" 
               class="px-3 py-1.5 border rounded hover:bg-gray-100 transition duration-150"><?php echo e($last); ?></a>
        <?php endif; ?>
        
        
        <?php if($pegawais->hasMorePages()): ?>
            <a href="<?php echo e($pegawais->nextPageUrl()); ?>" 
               class="px-3 py-1.5 border rounded hover:bg-gray-100 transition duration-150">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PKL POLITALA\dpmptsp\DPMPTSP\resources\views/admin/pegawai.blade.php ENDPATH**/ ?>