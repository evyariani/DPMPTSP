            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition duration-150">
                    ...
                    <td class="px-6 py-4 text-wrap-cell fixed-col-dasar">
                        ...
                        ?>
                        <?php if($dasarList && $dasarList->count() > 0): ?>
                            <div class="dasar-list">
                                <ul class="list-disc list-inside">
                                    <?php $__currentLoopData = $dasarList->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dasar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li title="<?php echo e($dasar); ?>"><?php echo e(Str::limit($dasar, 40)); ?></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($dasarList->count() > 3): ?>
                                        <li class="text-blue-500 tooltip">
                                            +<?php echo e($dasarList->count() - 3); ?> dasar lainnya
                                            <span class="tooltip-text">
                                                <?php $__currentLoopData = $dasarList->skip(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dasar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php echo e($dasar); ?><?php if(!$loop->last): ?>, <?php endif; ?>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </span>
                                        </li>
                                    <?php endif; ?>
                    ...
                    <td class="px-6 py-4 text-wrap-cell fixed-col-daerah">
                        ...
                        ?>
                        <?php if($daerahTujuan && $daerahTujuan != '-'): ?>
                            <div class="text-sm text-gray-900">
                                <?php echo e($daerahTujuan); ?>

                            </div>
                            <?php if($lhpd->tempat_tujuan_snapshot): ?>
                    ...
                    <td class="px-6 py-4 text-wrap-cell fixed-col-tempat">
                        ...
                        ?>
                        <?php if($tempatDikeluarkan && $tempatDikeluarkan != '-'): ?>
                            <div class="text-sm text-gray-900">
                                <?php echo e($tempatDikeluarkan); ?>

                            </div>
                            <?php if($lhpd->tempat_dikeluarkan_snapshot): ?>
                                <span class="snapshot-badge tooltip">
                                    <i class="fas fa-camera-retro text-xs"></i> snapshot
                                    <span class="tooltip-text">Data snapshot (tidak berubah)</span>
                                </span>
