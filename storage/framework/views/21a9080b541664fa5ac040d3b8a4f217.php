        ...
        <div class="flex flex-col md:flex-row md:items-center gap-4">
            <div class="flex-1">
                <input type="text" name="search" placeholder="Cari tujuan, dasar, hasil LHPD, atau daerah..."
                       value="<?php echo e(request('search')); ?>" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="flex flex-wrap gap-2">
                ...
                <select name="id_daerah" class="px-4 py-2 border rounded-lg">
                    ...
                    <?php $__currentLoopData = $daerahList ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $daerah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($daerah->id); ?>" <?php echo e(request('id_daerah') == $daerah->id ? 'selected' : ''); ?>><?php echo e($daerah->nama); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <?php if(request()->has('search') || request()->has('bulan') || request()->has('tahun') || request()->has('id_daerah')): ?>
                    <a href="<?php echo e(route('lhpd.index')); ?>" class="bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg"><i class="fas fa-redo mr-2"></i>Reset</a>
                <?php endif; ?>
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition">
                    <td class="px-4 py-4 text-sm text-gray-500 text-center"><?php echo e(($lhpdList->currentPage() - 1) * $lhpdList->perPage() + $index + 1); ?></td>
                    ...
                    <td class="px-4 py-4">
                        ...
                        <?php if(count($dasarArray) > 0): ?>
                            <div class="flex flex-wrap gap-1">
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php if(count($dasarArray) > 2): ?>
                                    <button onclick="showFullDasar(this, <?php echo e(json_encode($dasarArray)); ?>)" class="text-blue-500 text-xs">+<?php echo e(count($dasarArray) - 2); ?></button>
                                <?php endif; ?>
                            </div>
                        <?php else: ?>
                    ...
                    <!-- Tujuan -->
                    <td class="px-4 py-4">
                        <div class="text-sm text-gray-700 line-clamp-2" title="<?php echo e($lhpd->tujuan); ?>"><?php echo e(Str::limit($lhpd->tujuan ?? '-', 50)); ?></div>
                    </td>

                    <!-- Tanggal Berangkat -->
                    <td class="px-4 py-4 text-sm text-gray-600">
                        <?php echo e($lhpd->tanggal_berangkat ? \Carbon\Carbon::parse($lhpd->tanggal_berangkat)->format('d/m/Y') : '-'); ?>

                    </td>

                    <!-- Daerah Tujuan -->
                    <td class="px-4 py-4 text-sm text-gray-600">
                        <?php echo e($lhpd->tempat_tujuan_snapshot ?: '-'); ?>
                    ...
                    <td class="px-4 py-4">
                        ...
                        ?>
                        <?php if(count($hasilArray) > 0): ?>
                            <div class="text-sm text-gray-700 line-clamp-2" title="<?php echo e(implode('; ', $hasilArray)); ?>">
                                <?php echo e(Str::limit(implode('; ', $hasilArray), 60)); ?>
                    ...
                    <!-- Tempat Dikeluarkan -->
                    <td class="px-4 py-4 text-sm text-gray-600">
                        <?php echo e($lhpd->tempat_dikeluarkan_snapshot ?: '-'); ?>

                    </td>

                    <!-- Tanggal LHPD -->
                    <td class="px-4 py-4 text-sm text-gray-600">
                        <?php echo e($lhpd->tanggal_lhpd ? \Carbon\Carbon::parse($lhpd->tanggal_lhpd)->format('d/m/Y') : '-'); ?>

                    </td>

                    <!-- Foto -->
                    <td class="px-4 py-4 text-center">
                        <?php $fotoCount = $lhpd->foto_count; ?>
                        <?php if($fotoCount > 0): ?>
                            <button onclick="showGallery(<?php echo e($lhpd->id_lhpd); ?>)" class="gallery-thumb">
                                <div class="relative">
                                    <?php if($lhpd->first_foto_url): ?>
                                        <img src="<?php echo e($lhpd->first_foto_url); ?>" alt="Thumbnail" class="w-12 h-12 rounded-lg object-cover border">
                                    <?php else: ?>
                    ...
                    <td class="px-4 py-4 text-center">
                        <div class="flex items-center justify-center gap-2">
                            <a href="<?php echo e(route('lhpd.edit', $lhpd->id_lhpd)); ?>" class="text-green-600 hover:text-green-900 p-1 rounded hover:bg-green-50 tooltip" title="Edit LHPD">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="<?php echo e(route('lhpd.preview-pdf', $lhpd->id_lhpd)); ?>" target="_blank" class="text-blue-600 hover:text-blue-900 p-1 rounded hover:bg-blue-50 tooltip" title="Preview PDF">
                                <i class="fas fa-print"></i>
                            </a>
                            <button onclick="showDeleteConfirmation(<?php echo e($lhpd->id_lhpd); ?>, '<?php echo e(addslashes(Str::limit($lhpd->tujuan ?? '-', 50))); ?>', '<?php echo e(addslashes($lhpd->tanggal_berangkat ? \Carbon\Carbon::parse($lhpd->tanggal_berangkat)->format('d/m/Y') : '-')); ?>')" class="text-red-600 hover:text-red-900 p-1 rounded hover:bg-red-50 tooltip" title="Hapus LHPD">
                ...
                <tr>
                    <td colspan="10" class="px-4 py-12 text-center text-gray-500">
                        <div class="flex flex-col items-center">
                            ...
                            <a href="<?php echo e(route('spt.index')); ?>" class="mt-3 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg">Buat SPT</a>
                        </div>
                    </td>
                </tr>
                <?php endif; ?>
...
<div class="mt-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
    ...
    <div class="flex items-center space-x-1">
        ...
        <?php else: ?>
            <a href="<?php echo e($lhpdList->previousPageUrl()); ?>" 
        ...
        <?php if($start > 1): ?>
            <a href="<?php echo e($lhpdList->url(1)); ?>" 
        ...
        <?php for($page = $start; $page <= $end; $page++): ?>
            ...
            <?php else: ?>
                <a href="<?php echo e($lhpdList->url($page)); ?>" 
...
function exportData() {
    ...
    window.location.href = "<?php echo e(route('lhpd.export')); ?>?" + params.toString();
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\POLITALA\PKL\dpmptsp\resources\views/admin/lhpd.blade.php ENDPATH**/ ?>