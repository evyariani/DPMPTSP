...
@section('title', 'Tambah Kwitansi Perjalanan Dinas')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <!-- FORM CREATE -->
    <form action="{{ route('kwitansi.store') }}" method="POST" class="p-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="kode_rekening" value="{{ old('kode_rekening', '5.1.02.04.01.0001') }}" 
                ...
                <div>
                    ...
                    <input type="text" name="sub_kegiatan" value="{{ old('sub_kegiatan', 'Penyelenggaraan Konsultasi SKPD / Rapat Koordinasi') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="no_bku" value="{{ old('no_bku', '...../SRJ/GU-/2025') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="no_brpp" value="{{ old('no_brpp') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="number" name="nominal" value="{{ old('nominal', 600000) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="terbilang" value="{{ old('terbilang', 'Enam Ratus Ribu Rupiah') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_kwitansi" value="{{ old('tanggal_kwitansi', date('Y-m-d')) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="pengguna_anggaran" value="{{ old('pengguna_anggaran', 'BUDI ANDRIAN SUTANTO, S. Sos., MM') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_pengguna_anggaran" value="{{ old('nip_pengguna_anggaran', '19760218 200701 1 006') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="bendahara_pengeluaran" value="{{ old('bendahara_pengeluaran', 'NURLITA FEBRANA PRATWI, A.Md') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_bendahara" value="{{ old('nip_bendahara', '19980208 202012 2 007') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="penerima" value="{{ old('penerima', 'LIDIA MIRANTI MAYASARI, SE') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_penerima" value="{{ old('nip_penerima', '19840817 200903 2 022') }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
            </div>
