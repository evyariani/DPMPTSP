        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <select name="spd_id" id="spd_id" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    @foreach($spdList as $spd)
                    <option value="{{ $spd->id_spd }}" 
                            data-nomor="{{ $spd->nomor_surat }}"
                            data-maksud="{{ $spd->maksud_perjadin }}">
                        {{ $spd->nomor_surat }} - {{ substr($spd->maksud_perjadin, 0, 50) }}
                    </option>
                    @endforeach
                </select>
                    ...
                    <div class="p-4 space-y-4">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_kwitansi" id="tanggal_kwitansi" class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500" value="{{ date('Y-m-d') }}" required>
                            </div>
                            <div class="md:col-span-2">
