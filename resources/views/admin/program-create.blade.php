...
<div class="bg-white rounded-lg shadow overflow-hidden">
    <div class="p-6">
        <form action="{{ route('program.store') }}" method="POST" id="formProgram">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                placeholder="Masukkan nama program">{{ old('program') }}</textarea>
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach($rekenings ?? [] as $key => $value)
                                    <option value="{{ $key }}" {{ old('kode_rekening') == $key ? 'selected' : '' }}>
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 resize-textarea"
                                placeholder="Masukkan nama kegiatan">{{ old('kegiatan') }}</textarea>
                            <div class="mt-1 flex justify-between text-xs text-gray-500">
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 resize-textarea"
                                placeholder="Masukkan nama sub kegiatan">{{ old('sub_kegiatan') }}</textarea>
                            <div class="mt-1 flex justify-between text-xs text-gray-500">
