                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                            ...
                            value="{{ $kepalaDinas ? $kepalaDinas->nama . ' - ' . $kepalaDinas->nip . ' (' . $kepalaDinas->jabatan . ')' : 'Tidak ditemukan' }}"
                            readonly
                            disabled>

                        @if($kepalaDinas)
                        <input type="hidden" name="pengguna_anggaran" value="{{ $kepalaDinas->id_pegawai }}">
                        @endif
                    ...
                    <div>
                        ...
                        <select id="pptk_id"
                            ...
                            @foreach($pegawais as $pegawai)
                                <option value="{{ $pegawai->id_pegawai }}" {{ old('pptk_id') == $pegawai->id_pegawai ? 'selected' : '' }}>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                        <div class="space-y-3">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Pada Tanggal</label>
                                <input type="date" name="dikeluarkan_pada_tanggal" value="{{ date('Y-m-d') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg">
                            </div>
                        </div>
                    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePreviewPengguna() {
        ...
        if (preview) {
            ...
            @endphp
            preview.textContent = '{{ $kadis ? $kadis->nama : "-" }}';
        }
    }
