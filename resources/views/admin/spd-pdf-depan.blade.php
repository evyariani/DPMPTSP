    ...
    <table class="spd-table">
        ...
        <tr>
            ...
            <td class="col-content">
                ...
                @endphp
                @if($pelaksana && $pelaksana->count() > 0)
                    @foreach($pelaksana as $idx => $peg)
        ...
        <tr>
            ...
            <td class="col-content">
                a. Instansi : {{ $spd->skpd ?? 'Dinas Penanaman Modal dan PTSP' }}<br>
                b. Akun : {{ $spd->kode_rek ?? $spd->pejabat_teknis_kode_rekening ?? '-' }}
            </td>
        </tr>
