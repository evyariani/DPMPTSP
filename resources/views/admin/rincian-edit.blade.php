        ...
        <div class="p-4">
            ...
            @if($bendahara && ($bendahara->nama || $rincian->bendahara_nama))
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div>
                        <div class="font-medium text-gray-800">{{ $bendahara->nama ?? $rincian->bendahara_nama }}</div>
                        <div class="text-xs text-gray-500">
                            NIP: {{ $bendahara->nip ?? $rincian->bendahara_nip ?? '-' }} | 
                            Jabatan: {{ $bendahara->jabatan ?? $rincian->bendahara_jabatan ?? '-' }}
                        </div>
            ...
            @elseif($rincian->bendahara_pengeluaran_id && $rincian->bendaharaPengeluaran)
                ...
                <div class="flex items-center gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    ...
                    <div>
                        <div class="font-medium text-gray-800">{{ $rincian->bendaharaPengeluaran->nama }}</div>
                        <div class="text-xs text-gray-500">
            ...
            <p class="text-xs text-gray-500 mt-3">
                ...
                @if($rincian->bendahara_nama)
                    {{-- <br><i class="fas fa-camera ml-1"></i> Data sudah dalam bentuk snapshot (tidak akan berubah meskipun data pegawai berubah). --}}
                @endif
            </p>
        </div>
    </div>
