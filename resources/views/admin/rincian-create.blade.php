...
@section('title', 'Tambah Rincian Biaya Perjalanan Dinas')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    ...
    <form method="POST" action="{{ route('rincian.store') }}" id="formRincian">
        @csrf
                        ...
                        <div class="grid grid-cols-3 gap-3">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       value="{{ old('nominal_per_pegawai', 300000) }}"
                                       min="0"
                                       step="50000"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNama"
                                       name="bendahara_nama"
                                       value="{{ old('bendahara_nama', 'NURLITA FEBRIANA PRATIWI, A.Md') }}"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       id="bendaharaNip"
                                       name="bendahara_nip"
                                       value="{{ old('bendahara_nip', '19980208 202012 2 007') }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('kepala_dinas_nama', 'BUDI ANDRIAN SUTANTO, S. Sos., M.M') }}"
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('kepala_dinas_nip', '19760218 200701 1 006') }}"
