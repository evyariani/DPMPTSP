        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="tahun_anggaran" value="{{ old('tahun_anggaran', $kwitansi->tahun_anggaran) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="kode_rekening" value="{{ old('kode_rekening', $kwitansi->kode_rekening) }}" 
                ...
                <div>
                    ...
                    <input type="text" name="sub_kegiatan" value="{{ old('sub_kegiatan', $kwitansi->sub_kegiatan) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="no_bku" value="{{ old('no_bku', $kwitansi->no_bku) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="no_brpp" value="{{ old('no_brpp', $kwitansi->no_brpp) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="number" name="nominal" value="{{ old('nominal', $kwitansi->nominal) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" name="terbilang" value="{{ old('terbilang', $kwitansi->terbilang) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="date" name="tanggal_kwitansi" value="{{ old('tanggal_kwitansi', $kwitansi->tanggal_kwitansi) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="untuk_pembayaran" rows="4" 
                              class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              required>{{ old('untuk_pembayaran', $kwitansi->untuk_pembayaran) }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="pengguna_anggaran" value="{{ old('pengguna_anggaran', $kwitansi->pengguna_anggaran) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_pengguna_anggaran" value="{{ old('nip_pengguna_anggaran', $kwitansi->nip_pengguna_anggaran) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="bendahara_pengeluaran" value="{{ old('bendahara_pengeluaran', $kwitansi->bendahara_pengeluaran) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_bendahara" value="{{ old('nip_bendahara', $kwitansi->nip_bendahara) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="penerima" value="{{ old('penerima', $kwitansi->penerima) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="nip_penerima" value="{{ old('nip_penerima', $kwitansi->nip_penerima) }}" 
                           class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono"
                           required>
                </div>
            </div>
